...
// File: contracts/Platgentract.sol
...
contract Platgentract is AccessControl {
        ...
        notAlreadyVoted
    {
        ...
        bool[] memory set = new bool[](proposalIdCt.current() + 1);
    ...
    function _getPrefPairs() public view returns (uint256[4][] memory) {
        uint256 counter = 0;
        uint256 prefLength =
    ...
    function _getWinningPairs() public view returns (uint256[3][] memory) {
    ...
    function _getLockedPairs() private view returns (bool[][] memory) {
        ...
        bool[][] memory locked = initMultiArray(proposalIdCt.current() + 1);
